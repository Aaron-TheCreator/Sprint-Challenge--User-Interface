...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    ...
    Semantic HTML are specific HTML tags that provide structural and organization information about web-page content to the browser.

2. What are the 4 areas of the box model?

    The 4 areas of the box model are: 1.inner-content 2.padding 3.border 4. margin

3. While using flexbox, what axis does the following property work on: ```align-items: center```?

    "align-items" property works on the cross-axis of a given flex-box

4. Explain why git is valuable to a team of developers.

    "Git" is valluable to a team of developers because it allows for organized version control of a project as well as the ability for a Project's leader to review potential changes suggested by team members before adding them to the main "work-in-progress", as well as to revert back to previous versions seamlessly.

5. Define mobile-first design in your own words.

    Mobile-first design decribes a method of designing a website in which a developer used the stylesheet to design the website for its application on mobile devices first, before adding media queries to change the design for viewing on other form-factors, i.e. desktop & laptop.
...
* [v] Link the `About` navigation item to an about.html page (you'll also need to create `about.html`)
